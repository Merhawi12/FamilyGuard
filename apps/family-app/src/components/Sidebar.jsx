...
import { useAuth, useSocket, isStaff } from '@parentix/shared';
...
export default function Sidebar({ open, onClose }) {
  ...
  const showAdminLink = isStaff(user) && ADMIN_URL;
      ...
      <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
        ...
        {showAdminLink && (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-gray-600 hover:bg-gray-50 transition"
          >
